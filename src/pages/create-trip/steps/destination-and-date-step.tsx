        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <DayPicker 
              ...
              locale={ptBR}
              classNames={{
                day_range_start: 'rounded-r-none aria-selected:bg-lime-500 text-lime-950',
                day_range_middle: 'aria-selected:bg-lime-300/90 rounded-none text-lime-950',
                day_range_end: 'rounded-l-none aria-selected:bg-lime-500 text-lime-950',
              }}
            />
          </div>
        </div>
